...
TN: The implication is that in NASM it will also reserve space but, it will hesitate to fill them with zeroes. While filling the file with zeroes it prints a warning like this:
