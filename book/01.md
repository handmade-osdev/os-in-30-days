...
The path to hard drives and USBs usually looks like /dev/sd<letter>. Don't chose /dev/sda, since this is the drive the system is installed on.
...
Make sure you *don't* put space after `format=raw`. This will tell QEMU that we're explicitly loading a raw image.
